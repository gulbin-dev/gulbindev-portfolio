  ...
  return (
    ...
    >
      {projectList.projects.map((item) => (
        ...
        >
          <Card className="w-full grid grid-rows-[min-content_auto_1fr_auto]">
            ...
            >
              <ul aria-label="navigation" className="flex gap-1">
                <li>
                  <CTALinkButton link={item.homepage as string} target="_blank" className={`${item.name === 'gulbindev-portfolio' ? 'bg-this-website': ''}`}>
                   {item.name === 'gulbindev-portfolio'?  "This Website": "Visit Website" }
                  </CTALinkButton>
                </li>
                <li>
